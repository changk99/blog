export default (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
  return {
    data: {
          ...
          children: [
            {
              ...
              children: [
                { title: d, _path: '\u002Fbrowser_plugins\u002Fmodifyingwebdata\u002Finstall' },
                { title: i, _path: '\u002Fbrowser_plugins\u002Fmodifyingwebdata\u002Freadme' }
              ]
            },
            {
              title: '通用文字识别',
      ...
      'content-query-lKfKKdL60y': {
        _path: j,
        _dir: 'universaltextrecognition',
        _draft: e,
        _partial: e,
        _locale: 'zh-Hans',
        _empty: e,
        ...
        body: {
          type: 'root',
          children: [
            { type: a, tag: 'h2', props: { id: b }, children: [{ type: g, value: b }] },
            {
              type: a,
              tag: l,
              props: { code: 'hello\n', meta: null },
                      ...
                      children: [
                        {
                          ...
                          children: [
                            { type: a, tag: m, props: {}, children: [{ type: g, value: 'hello' }] }
                          ]
                        }
                      ]
                    }
            ...
            },
            {
              ...
              props: {},
              children: [
                { type: a, tag: 'h3', props: { id: c }, children: [{ type: g, value: c }] }
              ]
            }
          ],
          toc: {
            ...
            searchDepth: h,
            depth: h,
            links: [{ id: b, depth: h, text: b, children: [{ id: c, depth: 3, text: c }] }]
          }
        },
        _type: k,
        _id: 'content:browser_plugins:UniversalTextRecognition:install.md',
        _source: 'content',
        _file: 'browser_plugins\u002FUniversalTextRecognition\u002Finstall.md',
        _extension: 'md'
      }
    },
    prerenderedAt: 1685447127812
  };
})(
  'element',
  '知识点',
  ...
  2,
  '使用说明',
  '\u002Fbrowser_plugins\u002Funiversaltextrecognition\u002Finstall',
  'markdown',
  'code',
  'span'
);
