...
const A = q({
  ...
  async setup(a) {
    ...
    return { isPartial: v, data: y, refresh: p };
  },
  render(a) {
    var h;
    const t = N(),
    ...
    if (u.find === 'one') {
      if (!r && t != null && t['not-found']) return t['not-found']({ props: u, ...this.$attrs });
      if (
        t != null &&
        t.empty &&
        (r == null ? void 0 : r._type) === 'markdown' &&
        !((h = r == null ? void 0 : r.body) != null && h.children.length)
      )
    ...
    return t != null && t.default
      ? t.default({ data: r, refresh: n, isPartial: i, props: u, ...this.$attrs })
      : ((m, w) =>
          _(
            'pre',
            null,
            JSON.stringify(
              { message: 'You should use slots with <ContentQuery>!', slot: m, data: w },
              null,
              2
            )
          ))('default', { data: r, props: u, isPartial: i });
  }
});
export { A as default };
